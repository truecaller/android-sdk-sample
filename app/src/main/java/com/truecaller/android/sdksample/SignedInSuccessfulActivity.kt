...
class SignedInSuccessfulActivity : AppCompatActivity() {
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        when (flowType) {
            FLOW1 -> rootLayout.background = ContextCompat.getDrawable(this, R.drawable.success_bg_layer_flow1)
            FLOW2 -> rootLayout.background = ContextCompat.getDrawable(this, R.drawable.success_bg_layer_flow2)
            FLOW3, FLOW4 -> {
